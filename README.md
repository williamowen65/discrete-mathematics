...
- [Symbol Reference](SYMBOLS.md)
- [Course Outline](#course-outline)
  - [Unit 1 — Logic](01-logic/README.md)
  - [Unit 2 — Sets](#unit-2--sets)
  - [Unit 3 — Relations and Functions](#unit-3--relations-and-functions)
  - [Unit 4 — Proof and Mathematical Reasoning](#unit-4--proof-and-mathematical-reasoning)
  - [Unit 5 — Counting and Combinatorics](#unit-5--counting-and-combinatorics)
  - [Unit 6 — Discrete Probability](#unit-6--discrete-probability)
  - [Unit 7 — Recursion and Recurrence Relations](#unit-7--recursion-and-recurrence-relations)
  - [Unit 8 — Graph Theory](#unit-8--graph-theory)
  - [Unit 9 — Trees](#unit-9--trees)
  - [Unit 10 — Boolean Algebra](#unit-10--boolean-algebra)
  - [Unit 11 — Number Theory](#unit-11--number-theory)
  - [Unit 12 — Discrete Mathematics in Algorithms and Software Systems](#unit-12--discrete-mathematics-in-algorithms-and-software-systems)
- [Possible Final Project](#possible-final-project)
- [Status](#status)
...
[Open Unit 1 — Logic](01-logic/README.md)
...
**Software connections:** collections, database queries, filtering, roles and permissions, test-data domains, grouping objects by properties.
...
**Software connections:** database relationships, object associations, APIs and transformations, identity and equality, dependency ordering, state transitions.
...
**Software connections:** showing that an algorithm works, proving that an edge case cannot occur, reasoning about loops, validating recursive algorithms, expressing system guarantees.
...
**Software connections:** counting possible system states, estimating test combinations, password/search spaces, configuration explosion, brute-force algorithms.
...
**Software connections:** reliability, randomized algorithms, testing, failure probabilities, distributed systems, interpreting uncertain outcomes.
...
**Software connections:** recursive functions, divide-and-conquer algorithms, nested data, trees, repeated state transformations, algorithm runtime growth.
...
**Software connections:** dependency graphs, social networks, routing, build systems, package dependencies, workflow graphs, system architecture.
...
**Software connections:** file systems, DOM trees, abstract syntax trees, organizational hierarchies, search trees, hierarchical application data.
...
**Software connections:** complex conditionals, access-control logic, search filters, digital logic, simplifying predicates.
...
**Software connections:** hashing, cryptography, cyclic structures, checksums, identifiers, modular indexing.
...
**Software connections:** data structures and algorithms, complexity reasoning, dependency analysis, state-space modeling, system design, correctness arguments.
